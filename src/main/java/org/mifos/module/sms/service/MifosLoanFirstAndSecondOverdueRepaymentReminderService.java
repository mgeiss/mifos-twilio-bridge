...
public interface MifosLoanFirstAndSecondOverdueRepaymentReminderService {
	@GET("/runreports/{report_name}")
    public LoanFirstAndSecondOverdueRepaymentReminder findLoanReminder(@Header("Authorization") String authorization,
