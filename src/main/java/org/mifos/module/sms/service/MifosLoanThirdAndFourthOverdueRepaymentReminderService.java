...
public interface MifosLoanThirdAndFourthOverdueRepaymentReminderService {
	
	@GET("/runreports/{report_name}")
    public LoanThirdAndFourthOverdueRepaymentReminder findLoanReminder(@Header("Authorization") String authorization,
